 ...
 * @author LuisDanielCL
 */
public class AddMatrizJacobi extends javax.swing.JFrame {

    /**
     * Creates new form AddMatriz
     */
    MetodoJacobi vMadre = new MetodoJacobi();
    int filas, columnas, numMatriz;
    JTextField [][] valores = new JTextField[5][5];
    public AddMatrizJacobi(int pFilas, int pColumnas, MetodoJacobi pMadre) throws Exception {
        vMadre = pMadre;
    ...
    public Matriz llenarMatriz(Matriz matrizNueva) {
